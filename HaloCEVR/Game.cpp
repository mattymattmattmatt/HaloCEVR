...
void Game::SetupConfigs()
{
	...
	c_OffHandPoseForOneHanded = config.RegisterBool("OffHandPoseForOneHanded", "Hold the two hand grip while carrying a one handed weapon (pistol, plasma pistol, plasma rifle, needler) to snap the off hand to a supporting pose on the weapon. Purely visual - aiming is unchanged", false);
